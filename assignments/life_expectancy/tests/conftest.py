...
def run_before_and_after_tests() -> None:
    ...
    Thus, before you refactor the clean_data() function into 3 smaller functions,
    tests will produce a csv file on the output directory. Since this is bad
    practise, we are erasing this file to avoid polluting your workspace.
